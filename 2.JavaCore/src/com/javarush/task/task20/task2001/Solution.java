...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File your_file_name = File.createTempFile("fileBrandNew", ".txt",new File("L:\\"));
    ...
    public static class Human {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            if(name != null){
                ...
                Boolean isAssetsPresent = assets.isEmpty();
                printWriter.println(isAssetsPresent.toString());
                if(!isAssetsPresent){
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            if(isHumanPresent.equals("yes")){
                ...
                if(isAssetsPresent.equals("false")){
                    String assetName;
